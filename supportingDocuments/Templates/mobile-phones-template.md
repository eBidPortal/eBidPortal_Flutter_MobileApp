...
{
  "name": "Mobile Phones",
  "description": "Comprehensive template for mobile phones, smartphones, and cellular devices with detailed specifications, condition assessment, and marketplace features",
  ...
  "sections": [
    {
      ...
      "order": 1,
      "description": "Essential mobile phone details and identification",
      ...
      "fields": [
        {
          ...
          "validation": {
            "rules": ["required"],
            "custom_message": "Please select the phone brand"
          },
          "ui_config": {
            "placeholder": "Select brand",
            "options": [
              "Apple", "Samsung", "Google", "OnePlus", "Xiaomi", "Huawei", "Sony", "LG", "Motorola", "Nokia", "ASUS", "Realme", "Oppo", "Vivo", "Other"
            ]
          }
        },
        {
        ...
        },
        {
          ...
          "ui_config": {
            "placeholder": "e.g., A17 Pro, SM-S921B"
          }
        },
        {
          "name": "color",
          ...
          "validation": {
            "rules": ["required"],
            "custom_message": "Please select the phone color"
          },
          "ui_config": {
            "placeholder": "Select color",
            "options": [
              "Black", "White", "Silver", "Gold", "Rose Gold", "Blue", "Green", "Purple", "Red", "Gray", "Space Gray", "Midnight", "Starlight", "Pacific Blue", "Graphite", "Other"
            ]
          }
        },
        {
          ...
          "ui_config": {
            ...
            "options": [
              "64GB", "128GB", "256GB", "512GB", "1TB", "2TB", "Other"
            ]
          }
        },
        {
      ...
      "fields": [
        ...
        },
        {
          ...
          "ui_config": {
            ...
            "options": [
              "4GB", "6GB", "8GB", "12GB", "16GB", "18GB", "24GB", "Other"
            ]
          }
        },
        {
        ...
        },
        {
          ...
          "ui_config": {
            ...
            "options": [
              "OLED", "Super Retina XDR", "AMOLED", "Dynamic AMOLED", "LCD", "IPS LCD", "TFT", "Other"
            ]
          }
        },
        {
          ...
          "ui_config": {
            "placeholder": "e.g., 1179 x 2556, 1440 x 3120"
          }
        },
        {
          "name": "camera_main",
          ...
          "validation": {
            "rules": ["max_length:100"],
            "custom_message": "Camera specs cannot exceed 100 characters"
          },
          "ui_config": {
        ...
        },
        {
          ...
          "ui_config": {
            "placeholder": "e.g., 3274 mAh, 5000 mAh"
          }
        },
        {
          "name": "charging_speed",
          ...
          "ui_config": {
            "placeholder": "e.g., 27W wired, 15W wireless"
          }
        },
        {
          ...
          "ui_config": {
            ...
            "options": [
              "IP68", "IP67", "IPX8", "IPX7", "IPX4", "Not water resistant", "Unknown"
            ]
          }
        },
        {
          ...
          "ui_config": {
            "options": [
              "Fingerprint", "Face ID", "Iris Scanner", "Voice Recognition"
            ]
          }
        },
        {
          ...
          "ui_config": {
            "options": [
              "5G", "4G LTE", "Wi-Fi 6", "Wi-Fi 6E", "Bluetooth 5.0+", "NFC", "USB-C", "Lightning", "Wireless Charging", "GPS", "GLONASS", "BeiDou"
            ]
          }
        }
      ]
      ...
      "fields": [
        {
          ...
          "validation": {
            "rules": ["required"],
            "custom_message": "Please select the phone condition"
          },
          "ui_config": {
        ...
        },
        {
          ...
          "ui_config": {
            "options": [
              "Screen/Touch", "Cameras", "Speakers/Microphone", "Buttons", "Sensors", "Charging", "Wi-Fi/Bluetooth", "Cellular Network", "GPS", "Biometrics"
            ]
          }
        },
        {
        ...
        },
        {
          ...
          "ui_config": {
            "options": [
              "Original Box", "Charger", "USB Cable", "Headphones/Earbuds", "Screen Protector", "Case", "SIM Card Ejector", "Documentation"
            ]
          }
        },
        {
          ...
          "ui_config": {
            "label": "IMEI number has been verified and is clean"
          }
        },
        {
          "name": "imei_number",
          ...
          "validation": {
            "rules": ["pattern:^\\d{15}$"],
            "custom_message": "IMEI must be 15 digits"
          },
          "ui_config": {
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "ui_config": {
            "options": [
              "Standard Delivery", "Express Delivery", "Same Day Delivery", "Cash on Delivery", "Pickup Available"
            ]
          }
        },
        {
        ...
        },
        {
          ...
          "ui_config": {
            "placeholder": "e.g., 200 grams, 0.5 kg"
          }
        }
      ]
    },
      ...
      "fields": [
        {
          ...
          "ui_config": {
            "options": [
              "Wireless Charging", "Fast Charging", "Reverse Wireless Charging", "Expandable Storage", "Dual SIM", "eSIM Support", "SD Card Slot", "Headphone Jack", "Stereo Speakers", "Dolby Atmos", "Hi-Res Audio", "Gaming Optimized", "VR Ready", "5G Ready", "Military Grade Protection"
            ]
          }
        },
        {
        ...
        },
        {
          ...
          "ui_config": {
            "options": [
              "CE Certified", "FCC Certified", "RoHS Compliant", "Energy Star", "IP68 Rated", "MIL-STD-810G", "SAR Compliant"
            ]
          }
        }
      ]
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "ui_config": {
            "options": [
              "BIS Certified", "WPC Approved", "EMI/EMC Compliant", "Telecom Standards", "Safety Standards"
            ]
          }
        },
        {
