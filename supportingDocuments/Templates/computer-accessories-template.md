# Computer Accessories Template

```json
{
  "name": "Computer Accessories Template",
  "description": "Industry-level template for computer accessories including keyboards, mice, monitors, printers, speakers, webcams, cables, and peripherals with comprehensive specifications and validation rules.",
  "category_type": "computer_accessories",
  "is_active": true,
  "sections": [
    {
      ...
      "fields": [
        {
          ...
          "ui_config": {
            "placeholder": "Enter product title (e.g., Logitech MX Master 3 Wireless Mouse)",
        ...
        },
        {
          ...
          "ui_config": {
            "placeholder": "Enter brand name (e.g., Logitech, Dell, HP)",
        ...
        },
        {
          ...
          "ui_config": {
            "placeholder": "Enter model number (e.g., MX-MASTER-3)",
        ...
        },
        {
          ...
          "ui_config": {
            ...
            "help_text": "Primary category of the computer accessory"
          }
        },
        {
          "name": "compatibility",
          ...
          "ui_config": {
            "help_text": "Select all compatible operating systems and devices"
          }
        },
        {
    ...
    },
    {
      ...
      "order": 2,
      "description": "Detailed technical specifications and connectivity options",
      "is_collapsible": true,
      "fields": [
        {
          ...
          "ui_config": {
            "placeholder": "Select primary connectivity method",
            "help_text": "Main connection interface used by the accessory"
          }
        },
        {
          ...
          "ui_config": {
            "help_text": "Wireless connectivity standards supported (if applicable)"
          }
        },
        {
          "name": "dimensions",
        ...
        },
        {
          ...
          "ui_config": {
            "placeholder": "e.g., 5V DC, 2A via USB",
        ...
        },
        {
          ...
          "ui_config": {
            ...
            "help_text": "Include DPI, resolution, frequency, or other relevant specs"
          }
        }
      ]
    },
      ...
      "fields": [
        {
          ...
          "ui_config": {
            "help_text": "Current physical and functional condition of the accessory"
          }
        },
        {
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "ui_config": {
            "help_text": "Any age restrictions for using this product"
          }
        },
        {
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "ui_config": {
            "help_text": "Upload warranty cards, certificates, or other relevant documents"
          }
        },
        {
