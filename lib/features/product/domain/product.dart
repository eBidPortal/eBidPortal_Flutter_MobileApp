...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    try {
      return Product(
        id: json['id'] ?? '',
        title: json['title'] ?? json['productName'] ?? json['dynamic_attributes']?['title'] ?? json['dynamic_attributes']?['name'] ?? 'No Title',
        price: _parseDouble(json['price']) ?? _parseDouble(json['product_price']) ?? _parseDouble(json['dynamic_attributes']?['price']) ?? _parseDouble(json['dynamic_attributes']?['product_price']) ?? 0.0,
        currency: json['currency'] ?? json['dynamic_attributes']?['currency'] ?? 'INR',
        quantity: json['quantity'] ?? json['dynamic_attributes']?['quantity'] ?? 1,
        condition: json['condition'] ?? json['dynamic_attributes']?['condition'],
        description: json['description'] ?? json['dynamic_attributes']?['description'],
        ...
        images: json['images'] is List ? List<String>.from(json['images']) : (json['dynamic_attributes']?['images'] is List ? List<String>.from(json['dynamic_attributes']!['images']) : []),
        ...
        shipping: json['shipping'] is Map<String, dynamic> ? json['shipping'] : json['dynamic_attributes']?['shipping'],
        location: json['location'] is Map<String, dynamic> ? json['location'] : json['dynamic_attributes']?['location'],
        tags: json['tags'] is List ? List<String>.from(json['tags']) : (json['dynamic_attributes']?['tags'] is List ? List<String>.from(json['dynamic_attributes']!['tags']) : []),
